...
public class MainMenu extends AppCompatActivity implements View.OnClickListener {
    ...
    static HashMap<String, ArrayList<int[]>> correctMap = new HashMap<>();
    static HashMap<String, int[]> highestConsecMap = new HashMap<>(); //1st int is highest number, 2nd int is current counter
    static HashMap<String, Integer> successFirstMap = new HashMap<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correctMap = getCorrectMapFromSharedPref();
    }
    ...
    public HashMap getCorrectMapFromSharedPref() {
        SharedPreferences sharedpref = getSharedPreferences("CorrectMap", MODE_PRIVATE);
        String val = new Gson().toJson(new HashMap<String, ArrayList<int[]>>());
        String jsonStr = sharedpref.getString("CorrectMap", val);
        TypeToken<HashMap<String, ArrayList<int[]>>> token = new TypeToken<HashMap<String, ArrayList<int[]>>>() {};
        HashMap<String, ArrayList<int[]>> mapFromPref = new Gson().fromJson(jsonStr, token.getType());
        return mapFromPref;
    }
